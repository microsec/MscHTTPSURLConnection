...
-(NSData*)sendSynchronousRequest:(NSURLRequest*)request identity:(MscPKCS12*)identity identityPassword:(NSString*)identityPassword returningResponse:(NSURLResponse**)response validatorDelegate:(id<MscHTTPSValidatorDelegate>)validatorDelegate error:(MscHTTPSURLConnectionError**)error;
